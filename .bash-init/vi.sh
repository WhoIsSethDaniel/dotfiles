...
set_export_var VIM_VERSIONS "[stable]=0.9.1 [nightly]=0.10.0"
...
complete -F _complete_vim_plugins vim-cd vim-check vim-enable vim-enable-cs vim-disable vim-remove vim-log vim-config vim-freeze vim-thaw
