...
;   (#any-of? @_field
;     "Exec" "GetContext" "ExecContext" "SelectContext" "In" "RebindNamed" "Rebind" "Query" "QueryRow"
;     "QueryRowxContext" "NamedExec" "MustExec" "Get" "Queryx")
;   (#offset! @sql 0 1 0 -1))
;
...
;     field: (field_identifier) @_field
;     (#any-of? @_field
;       "Exec" "GetContext" "ExecContext" "SelectContext" "In" "RebindNamed" "Rebind" "Query"
;       "QueryRow" "QueryRowxContext" "NamedExec" "MustExec" "Get" "Queryx"))
;   (argument_list
