...
local function on_attach(client, bufnr)
  ...
  map_cond(rc.document_formatting, bufnr, 'n', '<leader>cf', "<cmd>lua require'lsp-format'.format()<CR>", opts)
  map_cond(rc.document_range_formatting, bufnr, 'n', '<leader>cf', "<cmd>lua require'lsp-format'.format()<CR>", opts)
